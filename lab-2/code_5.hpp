...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in '/Users/dominikwozniak/study/data_analytics/lab-2/code_5.stan', line 2, column 2 to column 22)",
                                                      " (in '/Users/dominikwozniak/study/data_analytics/lab-2/code_5.stan', line 6, column 2 to column 28)"};
...
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      if (jacobian__) {
        current_statement__ = 1;
        theta = stan::math::lb_constrain(theta, 0, lp__);
      } else {
        current_statement__ = 1;
        theta = stan::math::lb_constrain(theta, 0);
      }
      {
